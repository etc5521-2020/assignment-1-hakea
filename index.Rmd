...
```{r alt-plot, anchor = "Figure", results='asis'}
...
```{r regions, anchor = "Figure", results='asis', message=FALSE,warning=FALSE}
reg <- coffee_ratings %>% 
...
```{r producer, anchor = "Figure", results='asis', message=FALSE, warning=FALSE}
