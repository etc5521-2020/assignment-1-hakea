...
```{r best-country, anchor = "Figure", results='asis', fig.cap="Best country quality-wise"}
coun <- coffee_ratings %>% 
...
```{r alt-lrm}
 lm(total_cup_points ~ altitude_mean_meters, coffee_ratings) %>%   broom::tidy() %>% kable(caption = "Altitude v/s Quality stats") %>% kable_styling()
```

```{r alt-plot, anchor = "Figure", results='asis', fig.cap="Regression model for Altitude"}
ggplot(data = coffee_ratings, aes(x = total_cup_points, y = altitude_mean_meters)) +
  geom_point() +
  geom_smooth(method = lm)
```

```{r cor-test, eval=FALSE, warning=FALSE, message=FALSE}
...
```{r one-way,anchor = "Figure", results='asis',fig.cap="ANOVA test for processing methods vs Quality"}
...
```{r def-plot, anchor = "Figure", results='asis'}
...
```{r factor-plot,anchor = "Figure", results='asis',fig.cap="fitted vs resid for Individual grading criteria"}
...
```{r Eth-radar,anchor = "Figure", results='asis'}
...
```{r indo-radar,anchor = "Figure", results='asis'}
...
```{r regions, anchor = "Figure", results='asis', message=FALSE,warning=FALSE, fig.cap="Best Regions for the quality of coffee beans"}
reg <- coffee_ratings %>% 
...
```{r producer, anchor = "Figure", results='asis', message=FALSE, warning=FALSE, fig.cap="Largest producer country-wise"}
