...
## Dataset source
The data is originally observed from Coffee Quality Institute website and was scraped by [James DeLoux](https://github.com/jldbc/coffee-quality-database), the data was then re-posted on [Kaggle](https://www.kaggle.com/volpatto/coffee-quality-database-from-cqi?select=merged_data_cleaned.csv). Furthermore, [Thomas Mock](https://github.com/rfordatascience/tidytuesday/tree/master/data/2020/2020-07-07) did the initial cleaning for the scraped data. 
...
## Common processing method of top-graded coffee beans, and its behaviour on the individual grading criteria. (NEW)
...
The reports find out that neither altitude, blah blah blah, affect the quality of coffee.
Coffee beans from Ethiopia has the highest overall quality. However, the difference in coffee quality between countries is abysmal.
There are almost no differences in Coffee quality across the years.

In conclusion, neither country of origin, nor altitude, nor bla bla bla, ... does really have large impact on the quality ofcoffee. So, if you want to buy a bag of coffee, you should know about that and choose the coffee that best suited your taste bla bla bla
Although we data scientists tend to have the habit of drinking coffee alone in the dept of night, coffee tastes better with a group of friends.
