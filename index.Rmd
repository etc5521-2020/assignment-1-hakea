...
## Individual Criteria v/s Overall Quality (# Maybe remove moisture from this model?)

Then we pondered that individual grading criterias should definetely have a positive relationship with the overall quality of the coffee beans and we fitted a multi-variate model with all the individual grading criterias. This turns out to be true as all the individual grading criterias have a p-value of 0 and have a direct impact on the overall quality of the beans produced. As is visible in figure  the residuals fitted against the fitted values lie very close to the 0 line and hence is the best amongst all the models checked. The characteristic *moisture* has a p-value of 0.980 which is a considerably high value than that of the significance level, hence we have decided to remove it from any further analysis.
