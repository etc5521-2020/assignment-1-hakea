...
The question is, how do we, coffee lovers, should consider when planning to buy a premium bag of precious black beans?  Hence, in this report. We will have a journey to the place where the coffee trees were raised and the beans were harvested, to see what affects the quality of our beloved beans. we, coffee lovers, should consider when buying a premium bag of the 
...
# And find nothing (Well, from the dataset, they are at height 1901.64)
# So I detele them.
...
5. Are there any similarities in the processing method of top-graded coffee beans, how did processing method affect its individual grading criteria? (NEW)
...
## Are there any similarities in the processing method of top-graded coffee beans, how did processing method affect its individual grading criteria? (NEW)

**Processing Method amonst best-graded coffee beans**

```{r q5p1, results='asis', fig.cap="Common processing method of top 30 coffee beans by country"}

pro_md <- coffee_clean %>%
  dplyr::select(total_points, species, country, region, owner, method, aroma:moisture) %>%
...
**Effect of processing method on its individual grading criteria**
