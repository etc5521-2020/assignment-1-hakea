...
- For US, there are 3 areas that produce coffee beans: Mainland, Puerto Rico and Hawaii. In this research, the researcher merge all this area together to better represent the country.
...
# I (Thomas) performed a quick check, and it is from colombia (based on the producer). So I changed it
