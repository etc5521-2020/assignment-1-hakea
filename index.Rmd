...
Based on the data limitations and 
...
## What is the trend in grading date? (NEW)
...
p3 <- coffee_clean_date %>% 
  ...
  xlab("Day")+
  ggtitle("Mean Total Score by day")+
  theme(plot.title = element_text(hjust = 0.5))
